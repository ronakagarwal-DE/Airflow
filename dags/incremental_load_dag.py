...
@dag(
    schedule=CronDataIntervalTimetable("@daily",timezone="Asia/Calcutta"),
    start_date=datetime(year=2026, month=1, day=26, tz="Asia/Calcutta"),
    end_date=datetime(year=2026, month=1, day=31, tz="Asia/Calcutta"),
    catchup=True
)
